...
export const ADMIN_QUESTIONS_EASY = { path: "/admin/questions/questions", title: "Questions Easy" };
export const ADMIN_QUESTIONS_MID = { path: "/admin/questions/questions-mid", title: "Questions Mid" };
export const ADMIN_QUESTIONS_PRO = { path: "/admin/questions/questions-pro", title: "Questions Pro" };
...
export const QUESTIONS = { path: "/topics", title: "Easy" };
